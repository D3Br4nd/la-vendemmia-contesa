...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = {
        ...
        GRAPE_TYPES: window.GRAPE_TYPES,
        GRAPE_COLORS: window.GRAPE_COLORS,
        GRID_CONFIG: window.GRID_CONFIG,
        GAME_CONFIG: window.GAME_CONFIG,
        PHYSICS: window.PHYSICS,
        COLORS: window.COLORS,
        UI_CONFIG: window.UI_CONFIG,
        AUDIO_CONFIG: window.AUDIO_CONFIG,
        LEVEL_CONFIG: window.LEVEL_CONFIG,
        INPUT_CONFIG: window.INPUT_CONFIG,
        ANIMATION_CONFIG: window.ANIMATION_CONFIG,
        DEBUG_CONFIG: window.DEBUG_CONFIG,
        API_CONFIG: window.API_CONFIG,
        SHOOTER_CONFIG: window.SHOOTER_CONFIG
    };
}
